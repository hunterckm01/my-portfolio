...
const HomeTab = () => {
    ...
    return(
    <section className="w-full bg-slate-950 pt-16" id = "Home">
        <article className=" w-full tablet:max-w-[90%] pc:max-w-[75%] mx-auto flex mobile:flex-col tablet:flex-row justify-between items-center gap-12 pt-8 my-12">
            ...
            <img src = {profileImg} alt = "Profile Img" loading="lazy" className="grayscale-[75%] w-[400px] hover:grayscale-0 hover:transition-all hover:duration-700 transition-all duration-700" relative/>
